...
.. image:: https://readthedocs.org/projects/bdc-db/badge/?version=v0.2.1
        :target: https://bdc-db.readthedocs.io/en/v0.2.1/
...
.. image:: https://github.com/brazil-data-cube/bdc-db/raw/v0.2.1/doc/model/db-schema.png
        :target: https://github.com/brazil-data-cube/bdc-db/tree/v0.2.1/doc/model
        :width: 90%
        :alt: Database Schema
